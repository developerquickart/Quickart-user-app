...
import 'sneaky_product_list_screen_model.dart';
export 'sneaky_product_list_screen_model.dart';

class SneakyProductListScreenWidget extends StatefulWidget {
  const SneakyProductListScreenWidget({
    super.key,
    this.utmSource,
    this.utmCampaign,
    this.utmNetwork,
  ...
  static String routeName = 'SneakyProductListScreen';
  static String routePath = '/sneaky-product';

  @override
  State<SneakyProductListScreenWidget> createState() =>
      _SneakyProductListScreenWidgetState();
}
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SNEAKY_PRODUCT_LIST_SCREEN_chevron_left_');
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'SNEAKY_PRODUCT_LIST_SCREEN_Stack_v36bdnu');
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: (_model.apiRequestCompleter ??= Completer<
                                ...
                                ..complete(
                                  ...
                                  long: functions.getCurrentLatitudeLogitude(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final gridViewSneakyproductlistResponse =
                                snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final productModel = getJsonField(
                                  gridViewSneakyproductlistResponse.jsonBody,
                                  r'''$.data''',
                                ).toList();
                                ...
                                return RefreshIndicator(
                                  onRefresh: () async {
                                    logFirebaseEvent(
                                        'SNEAKY_PRODUCT_LIST_SCREEN_GridView_gqfw');
                                    logFirebaseEvent(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, productModelIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SNEAKY_PRODUCT_LIST_SCREEN_Container_jlk');
                                          logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('SNEAKY_PRODUCT_LIST_SCREEN_ADD_BTN_ON_TA');
                                                                              if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                ...
                                                                                safeSetState(() => _model.apiRequestCompleter = null);
                                                                                await _model.waitForApiRequestCompleted(maxWait: 3000);
                                                                              } else {
                                                                          ...
                                                                          children: [
                                                                            Align(
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('SNEAKY_PRODUCT_LIST_SCREEN__BTN_ON_TAP');
                                                                                  if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                    logFirebaseEvent('Button_bottom_sheet');
                                                                                    await showModalBottomSheet(
                                                                                      isScrollControlled: true,
                                                              ...
                                                              if ((getJsonField(
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'SNEAKY_PRODUCT_LIST_SCREEN_Row_dzpgm749_');
                                                                    logFirebaseEvent(
                                                                        'Row_bottom_sheet');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                  ...
                                                                  if (FFAppConstants
                                                                    ...
                                                                    return FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'SNEAKY_PRODUCT_LIST_SCREEN_notifications');
                                                                        logFirebaseEvent(
                                                                            'IconButton_custom_action');
                                                                        _model.connnectivtysneaky =
                                                                            await actions.checkInternetConnection();
                                                                        if (_model.connnectivtysneaky ==
                                                                            true) {
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          _model.sneaky = await QuickartGroup
                                                                              .addnotifymeCall
                                                                              .call(
                                                                            productID:
                                                                                getJsonField(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'SNEAKY_PRODUCT_LIST_SCREEN_CircleImage_p');
                                                                          logFirebaseEvent(
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SNEAKY_PRODUCT_LIST_SCREEN_Icon1_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon1_custom_action');
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SNEAKY_PRODUCT_LIST_SCREEN_Icon2_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon2_custom_action');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SNEAKY_PRODUCT_LIST_SCREEN_cartbtnContai');
                                logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SNEAKY_PRODUCT_LIST_SCREEN_Row_9afjr1xv_');
              ...
              if (FFAppState().refreshTrigger == true)
                Container(
                  ...
                  child: FlutterFlowTimer(
                    ...
                    onEnded: () async {
                      logFirebaseEvent(
                          'SNEAKY_PRODUCT_LIST_SCREEN_Timer_fic2rw6');
