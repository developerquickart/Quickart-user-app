...
import 'searchby_popup_banner_model.dart';
export 'searchby_popup_banner_model.dart';

class SearchbyPopupBannerWidget extends StatefulWidget {
  const SearchbyPopupBannerWidget({
    super.key,
    this.title,
    this.id,
    this.utmSource,
  ...
  static String routeName = 'searchbyPopupBanner';
  static String routePath = '/search-popup-banner';

  @override
  State<SearchbyPopupBannerWidget> createState() =>
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SEARCHBY_POPUP_BANNER_chevron_left_ICN_O');
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'SEARCHBY_POPUP_BANNER_Stack_cr2mcmps_ON_');
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final gridViewSearchbypopupbannerResponse =
                                    snapshot.data!;

                                return Builder(
                                  builder: (context) {
                                    final productModel = getJsonField(
                                      gridViewSearchbypopupbannerResponse
                                          .jsonBody,
                                      r'''$.data''',
                                    ).toList();
                                    ...
                                    return RefreshIndicator(
                                      onRefresh: () async {
                                        logFirebaseEvent(
                                            'SEARCHBY_POPUP_BANNER_GridView_3heh1q3t_');
                                        logFirebaseEvent(
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SEARCHBY_POPUP_BANNER_Container_7kgezoc1');
                                              logFirebaseEvent(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('SEARCHBY_POPUP_BANNER_ADD_BTN_ON_TAP');
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Align(
                                                                                    ...
                                                                                    child: FFButtonWidget(
                                                                                      onPressed: () async {
                                                                                        logFirebaseEvent('SEARCHBY_POPUP_BANNER_PAGE__BTN_ON_TAP');
                                                                                        if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                          logFirebaseEvent('Button_bottom_sheet');
                                                                                          await showModalBottomSheet(
                                                                                            isScrollControlled: true,
                                                                  ...
                                                                  if ((getJsonField(
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'SEARCHBY_POPUP_BANNER_Row_7j8avpuj_ON_TA');
                                                                        logFirebaseEvent(
                                                                            'Row_bottom_sheet');
                                                                        await showModalBottomSheet(
                                                                          isScrollControlled:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      if (FFAppConstants
                                                                        ...
                                                                        return FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('SEARCHBY_POPUP_BANNER_notifications_none');
                                                                            logFirebaseEvent('IconButton_custom_action');
                                                                            _model.connnectivtysearchbanner =
                                                                                await actions.checkInternetConnection();
                                                                            if (_model.connnectivtysearchbanner ==
                                                                                true) {
                                                                        ...
                                                                        return Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('SEARCHBY_POPUP_BANNER_CircleImage_u1mu1d');
                                                        ...
                                                        if (FFAppConstants
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SEARCHBY_POPUP_BANNER_PAGE_Icon1_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon1_custom_action');
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SEARCHBY_POPUP_BANNER_PAGE_Icon2_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon2_custom_action');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SEARCHBY_POPUP_BANNER_cartbtnContainer_O');
                                  logFirebaseEvent(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SEARCHBY_POPUP_BANNER_Row_xdt9x3ka_ON_TA');
                ...
                if (FFAppState().refreshTrigger == true)
                  Container(
                    ...
                    child: FlutterFlowTimer(
                      ...
                      onEnded: () async {
                        logFirebaseEvent(
                            'SEARCHBY_POPUP_BANNER_Timer_bz7seax4_ON_');
