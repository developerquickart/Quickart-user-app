...
import 'searchby_banner_model.dart';
export 'searchby_banner_model.dart';

class SearchbyBannerWidget extends StatefulWidget {
  const SearchbyBannerWidget({
    super.key,
    this.name,
    this.utmSource,
    this.utmCampaign,
  ...
  static String routeName = 'searchbyBanner';
  static String routePath = '/banner-product-list';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SEARCHBY_BANNER_chevron_left_ICN_ON_TAP');
              if (widget.name != null && widget.name != '') {
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('SEARCHBY_BANNER_Icon_kq5q5stw_ON_TAP');
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('SEARCHBY_BANNER_Stack_knukhwn3_ON_TAP');
                    ...
                    child: Stack(
                      children: [
                        Align(
                          alignment: AlignmentDirectional(-7.7, 0.0),
                          child: Padding(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              future: (_model.apiRequestCompleter ??= Completer<
                                    ...
                                    ..complete(
                                      ...
                                      deviceid: FFAppState().deviceID,
                                      brandID: widget.banner == null ||
                                              widget.banner == ''
                                          ? FFAppState().brandID
                                          : widget.banner,
                                      bannerID: widget.banner != null &&
                                              widget.banner != ''
                                          ? widget.banner
                                          : FFAppState().catID,
                                      page: 1,
                                      pageper: 100,
                                      bannerType: widget.type != null &&
                                              widget.type != ''
                                          ? widget.type
                              ...
                              builder: (context, snapshot) {
                                ...
                                final gridViewSearchByBannerResponse =
                                    snapshot.data!;

                                return Builder(
                                  builder: (context) {
                                    final productModel = getJsonField(
                                      gridViewSearchByBannerResponse.jsonBody,
                                      r'''$.data''',
                                    ).toList();
                                    ...
                                    return RefreshIndicator(
                                      onRefresh: () async {
                                        logFirebaseEvent(
                                            'SEARCHBY_BANNER_GridView_nzelmr0g_ON_PUL');
                                        logFirebaseEvent(
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SEARCHBY_BANNER_Container_tcvhoe27_ON_TA');
                                              logFirebaseEvent(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('SEARCHBY_BANNER_PAGE_ADD_BTN_ON_TAP');
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Align(
                                                                                    ...
                                                                                    child: FFButtonWidget(
                                                                                      onPressed: () async {
                                                                                        logFirebaseEvent('SEARCHBY_BANNER_PAGE__BTN_ON_TAP');
                                                                                        if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                          logFirebaseEvent('Button_bottom_sheet');
                                                                                          await showModalBottomSheet(
                                                                                            isScrollControlled: true,
                                                                                            ...
                                                                                            if ((_model.addtoCartAPI1?.succeeded ?? true)) {
                                                                                              ...
                                                                                              logFirebaseEvent(
                                                                                                ...
                                                                                                parameters: {
                                                                                                  ...
                                                                                                  'Screen Name': 'Search By Banner Screen',
                                                                                                },
                                                                                              );
                                                                                              logFirebaseEvent('Button_custom_action');
                                                                                              await actions.facebookEventClass(
                                                                  ...
                                                                  if ((getJsonField(
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'SEARCHBY_BANNER_PAGE_Row_2uvpwl5c_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Row_bottom_sheet');
                                                                        await showModalBottomSheet(
                                                                          isScrollControlled:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        if (FFAppConstants.notifyMe ==
                                                                          ...
                                                                          return FlutterFlowIconButton(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('SEARCHBY_BANNER_notifications_none_sharp');
                                                                              logFirebaseEvent('IconButton_custom_action');
                                                                              _model.connnectivtysearchbanner = await actions.checkInternetConnection();
                                                                              if (_model.connnectivtysearchbanner == true) {
                                                                                logFirebaseEvent('IconButton_haptic_feedback');
                                                                                HapticFeedback.mediumImpact();
                                                                                logFirebaseEvent('IconButton_backend_call');
                                                                                _model.searchbybanner = await QuickartGroup.addnotifymeCall.call(
                                                                                ...
                                                                                if ((_model.searchbybanner?.succeeded ?? true)) {
                                                                                  ...
                                                                                  ScaffoldMessenger.of(context).showSnackBar(
                                                                                    SnackBar(
                                                                                      content: Text(
                                                                                        getJsonField(
                                                                                          (_model.searchbybanner?.jsonBody ?? ''),
                                                                                          r'''$.message''',
                                                                                        ).toString(),
                                                                                        style: GoogleFonts.montserrat(
                                                                                          color: FFAppConstants.indigoColor,
                                                                          ...
                                                                          return Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              highlightColor: Colors.transparent,
                                                                              onTap: () async {
                                                                                logFirebaseEvent('SEARCHBY_BANNER_CircleImage_8veoaapx_ON_');
                                                        ...
                                                        if (FFAppConstants
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SEARCHBY_BANNER_PAGE_Icon1_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon1_custom_action');
                                                          ...
                                                          return Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SEARCHBY_BANNER_PAGE_Icon2_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon2_custom_action');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'SEARCHBY_BANNER_cartbtnContainer_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SEARCHBY_BANNER_PAGE_Row_a9wvxuu1_ON_TAP');
                ...
                if (FFAppState().refreshTrigger == true)
                  Container(
                    ...
                    child: FlutterFlowTimer(
                      ...
                      onEnded: () async {
                        logFirebaseEvent(
                            'SEARCHBY_BANNER_Timer_l3g3bu6t_ON_TIMER_');
