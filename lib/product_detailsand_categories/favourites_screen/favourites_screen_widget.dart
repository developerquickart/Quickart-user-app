      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('FAVOURITES_SCREEN_chevron_left_ICN_ON_TA');
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('FAVOURITES_SCREEN_Stack_g7burcoo_ON_TAP');
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final gridViewShowwishlistResponse = snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final productModel = getJsonField(
                                  gridViewShowwishlistResponse.jsonBody,
                                  r'''$.data''',
                                ).toList();
                                ...
                                return RefreshIndicator(
                                  onRefresh: () async {
                                    logFirebaseEvent(
                                        'FAVOURITES_SCREEN_GridView_lxau5jk6_ON_P');
                                    logFirebaseEvent(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, productModelIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FAVOURITES_SCREEN_Container_4bknk7ol_ON_');
                                          logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('FAVOURITES_SCREEN_PAGE_ADD_BTN_ON_TAP');
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('FAVOURITES_SCREEN_PAGE__BTN_ON_TAP');
                                                                                    if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                      logFirebaseEvent('Button_bottom_sheet');
                                                                                      await showModalBottomSheet(
                                                                                        isScrollControlled: true,
                                                              ...
                                                              if ((getJsonField(
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'FAVOURITES_SCREEN_Row_gur2me8o_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Row_bottom_sheet');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                  ...
                                                                  if (FFAppConstants
                                                                    ...
                                                                    return FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'FAVOURITES_SCREEN_notifications_none_sha');
                                                                        logFirebaseEvent(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'FAVOURITES_SCREEN_CircleImage_hp5jknor_O');
                                                                          logFirebaseEvent(
                                                    ...
                                                    if (FFAppConstants
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'FAVOURITES_SCREEN_PAGE_Icon1_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon1_custom_action');
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'FAVOURITES_SCREEN_PAGE_Icon2_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon2_custom_action');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'FAVOURITES_SCREEN_cartbtnContainer_ON_TA');
                                logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'FAVOURITES_SCREEN_Row_tsr5futp_ON_TAP');
