...
import 'additional_cat_screen_model.dart';
export 'additional_cat_screen_model.dart';

class AdditionalCatScreenWidget extends StatefulWidget {
  const AdditionalCatScreenWidget({
    super.key,
    this.name,
    this.utmSource,
    this.utmCampaign,
  ...
  static String routeName = 'AdditionalCatScreen';
  static String routePath = '/additional-categories';

  @override
  State<AdditionalCatScreenWidget> createState() =>
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADDITIONAL_CAT_SCREEN_chevron_left_ICN_O');
              if (widget.name != null && widget.name != '') {
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'ADDITIONAL_CAT_SCREEN_Stack_3e4k5ffo_ON_');
                      ...
                      Padding(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: (_model.apiRequestCompleter ??= Completer<
                                  ApiCallResponse>()
                                ..complete(
                                    QuickartGroup.additionalCatSearchCall.call(
                            ...
                            return Builder(
                              builder: (context) {
                                final productModel = getJsonField(
                                  gridViewAdditionalCatSearchResponse.jsonBody,
                                  r'''$.data''',
                                ).toList();
                                ...
                                return RefreshIndicator(
                                  onRefresh: () async {
                                    logFirebaseEvent(
                                        'ADDITIONAL_CAT_SCREEN_GridView_l1210tx5_');
                                    logFirebaseEvent(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, productModelIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ADDITIONAL_CAT_SCREEN_Container_34ii1hj1');
                                          logFirebaseEvent(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('ADDITIONAL_CAT_SCREEN_ADD_BTN_ON_TAP');
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('ADDITIONAL_CAT_SCREEN_PAGE__BTN_ON_TAP');
                                                                                    if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                      logFirebaseEvent('Button_bottom_sheet');
                                                                                      await showModalBottomSheet(
                                                                                        isScrollControlled: true,
                                                              ...
                                                              if ((getJsonField(
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'ADDITIONAL_CAT_SCREEN_Row_x6ky3dst_ON_TA');
                                                                    logFirebaseEvent(
                                                                        'Row_bottom_sheet');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                  ...
                                                                  if (FFAppConstants
                                                                    ...
                                                                    return FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ADDITIONAL_CAT_SCREEN_notifications_none');
                                                                        logFirebaseEvent(
                                                                            'IconButton_custom_action');
                                                                        _model.connnectivtyaddcat =
                                                                            await actions.checkInternetConnection();
                                                                        if (_model.connnectivtyaddcat ==
                                                                            true) {
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          _model.addcat = await QuickartGroup
                                                                              .addnotifymeCall
                                                                              .call(
                                                                            productID:
                                                                                getJsonField(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'ADDITIONAL_CAT_SCREEN_CircleImage_yhb33o');
                                                                          logFirebaseEvent(
                                                    ...
                                                    if (FFAppConstants
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'ADDITIONAL_CAT_SCREEN_PAGE_Icon1_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon1_custom_action');
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'ADDITIONAL_CAT_SCREEN_PAGE_Icon2_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon2_custom_action');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ADDITIONAL_CAT_SCREEN_cartbtnContainer_O');
                                logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ADDITIONAL_CAT_SCREEN_Row_mdnekl98_ON_TA');
              ...
              if (FFAppState().refreshTrigger == true)
                Container(
                  ...
                  child: FlutterFlowTimer(
                    ...
                    onEnded: () async {
                      logFirebaseEvent(
                          'ADDITIONAL_CAT_SCREEN_Timer_75pr5wh8_ON_');
