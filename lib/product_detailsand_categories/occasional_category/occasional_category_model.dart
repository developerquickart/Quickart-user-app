...
import '/index.dart';
import 'dart:async';
import 'occasional_category_widget.dart' show OccasionalCategoryWidget;
...
class OccasionalCategoryModel
  ...
  // Stores action output result for [Backend Call - API (seosource)] action in OccasionalCategory widget.
  ApiCallResponse? apiResultSeoSourceOc;
