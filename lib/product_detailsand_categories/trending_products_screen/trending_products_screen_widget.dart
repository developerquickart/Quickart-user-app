...
import 'trending_products_screen_model.dart';
export 'trending_products_screen_model.dart';

class TrendingProductsScreenWidget extends StatefulWidget {
  const TrendingProductsScreenWidget({
    super.key,
    this.utmSource,
    this.utmCampaign,
    this.utmNetwork,
  ...
  static String routeName = 'TrendingProductsScreen';
  static String routePath = '/recent-selling-product-list';

  @override
  State<TrendingProductsScreenWidget> createState() =>
      _TrendingProductsScreenWidgetState();
}

class _TrendingProductsScreenWidgetState
    extends State<TrendingProductsScreenWidget> {
  late TrendingProductsScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrendingProductsScreenModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'TrendingProductsScreen'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('TRENDING_PRODUCTS_SCREEN_TrendingProduct');
      if (widget.utmSource != null && widget.utmSource != '') {
        logFirebaseEvent('TrendingProductsScreen_backend_call');
        ...
        if ((_model.apiResultSeoSource?.succeeded ?? true)) {
          ...
          logFirebaseEvent('TrendingProductsScreen_show_snack_bar');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('TRENDING_PRODUCTS_SCREEN_chevron_left_IC');
              if (widget.utmSource == null || widget.utmSource == '') {
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'TRENDING_PRODUCTS_SCREEN_Stack_y18hkc07_');
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final gridViewRecentsellingResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final productModel = getJsonField(
                                    gridViewRecentsellingResponse.jsonBody,
                                    r'''$.data''',
                                  ).toList();
                                  ...
                                  return RefreshIndicator(
                                    onRefresh: () async {
                                      logFirebaseEvent(
                                          'TRENDING_PRODUCTS_SCREEN_GridView_c4r8f1');
                                      logFirebaseEvent(
                                      ...
                                      await _model.waitForApiRequestCompleted();
                                      logFirebaseEvent(
                                          'GridView_update_page_state');
                                      _model.productListJ = getJsonField(
                                        gridViewRecentsellingResponse.jsonBody,
                                        r'''$.data''',
                                      );
                                      safeSetState(() {});
                                    ...
                                    child: GridView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'TRENDING_PRODUCTS_SCREEN_Container_4r9d3');
                                            logFirebaseEvent(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('TRENDING_PRODUCTS_SCREEN_ADD_BTN_ON_TAP');
                                                                                        ...
                                                                                        if (FFAppConstants.checkStatus ==
                                                                                          ...
                                                                                          logFirebaseEvent(
                                                                                            ...
                                                                                            parameters: {
                                                                                              ...
                                                                                              'Screen Name': 'Trending Product Screen',
                                                                                            },
                                                                                          );
                                                                                          logFirebaseEvent('Button_custom_action');
                                                                                          await actions.facebookEventClass(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Align(
                                                                                  ...
                                                                                  child: FFButtonWidget(
                                                                                    onPressed: () async {
                                                                                      logFirebaseEvent('TRENDING_PRODUCTS_SCREEN__BTN_ON_TAP');
                                                                                      if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                        logFirebaseEvent('Button_bottom_sheet');
                                                                                        await showModalBottomSheet(
                                                                                          isScrollControlled: true,
                                                                ...
                                                                if ((getJsonField(
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'TRENDING_PRODUCTS_SCREEN_Row_oi6jv0q6_ON');
                                                                      logFirebaseEvent(
                                                                          'Row_bottom_sheet');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                                    ...
                                                                    if (FFAppConstants
                                                                      ...
                                                                      return FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'TRENDING_PRODUCTS_SCREEN_notifications_n');
                                                                          logFirebaseEvent(
                                                                              'IconButton_custom_action');
                                                                          _model.connnectivtytrenbrand =
                                                                              await actions.checkInternetConnection();
                                                                          if (_model.connnectivtytrenbrand ==
                                                                              true) {
                                                                            logFirebaseEvent('IconButton_haptic_feedback');
                                                                            HapticFeedback.mediumImpact();
                                                                            logFirebaseEvent('IconButton_backend_call');
                                                                            _model.trendbrand =
                                                                                await QuickartGroup.addnotifymeCall.call(
                                                                            ...
                                                                            if ((_model.trendbrand?.succeeded ??
                                                                                true)) {
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('TRENDING_PRODUCTS_SCREEN_CircleImage_gyh');
                                                      ...
                                                      if (FFAppConstants
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TRENDING_PRODUCTS_SCREEN_Icon1_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon1_custom_action');
                                                            ...
                                                            Container(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'TRENDING_PRODUCTS_SCREEN_Icon2_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Icon2_custom_action');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'TRENDING_PRODUCTS_SCREEN_cartbtnContaine');
                                logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'TRENDING_PRODUCTS_SCREEN_Row_3xmzeanb_ON');
