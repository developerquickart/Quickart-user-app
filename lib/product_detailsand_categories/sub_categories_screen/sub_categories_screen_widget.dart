          ...
          title: Row(
            ...
            children: [
              ...
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('SUB_CATEGORIES_SCREEN_filter_alt_ICN_ON_');
                  ...
                  _model.productModelJson = null;
                  _model.isFilterSelected = _model.selectedFilter!;
                  safeSetState(() {});
                  logFirebaseEvent('IconButton_backend_call');
                  _model.apiResultCartProductFilter =
                  ...
                  if ((_model.apiResultCartProductFilter?.succeeded ?? true)) {
                    logFirebaseEvent('IconButton_update_page_state');
                    _model.productModelJson = getJsonField(
                      (_model.apiResultCartProductFilter?.jsonBody ?? ''),
                      r'''$.data''',
                    );
                    _model.isLoadingIndicator = false;
                    safeSetState(() {});
                                              ...
                                              Align(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    _model.apiResultCartProductAll =
                                                        await QuickartGroup
                                                            .catproductCall
                                                            .call(
                                                      userid:
