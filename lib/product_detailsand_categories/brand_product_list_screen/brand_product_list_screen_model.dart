...
import 'dart:async';
import '/index.dart';
import 'brand_product_list_screen_widget.dart'
    show BrandProductListScreenWidget;
import 'package:stop_watch_timer/stop_watch_timer.dart';
import 'package:flutter/material.dart';

class BrandProductListScreenModel
    extends FlutterFlowModel<BrandProductListScreenWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - API (seosource)] action in BrandProductListScreen widget.
