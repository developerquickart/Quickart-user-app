...
import 'brand_product_list_screen_model.dart';
export 'brand_product_list_screen_model.dart';

class BrandProductListScreenWidget extends StatefulWidget {
  const BrandProductListScreenWidget({
    super.key,
    this.id,
    this.keywordPage,
    this.utmSource,
  ...
  static String routeName = 'BrandProductListScreen';
  static String routePath = '/brand-product-list';

  @override
  State<BrandProductListScreenWidget> createState() =>
      _BrandProductListScreenWidgetState();
}
            ...
            children: [
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'BRAND_PRODUCT_LIST_SCREEN_Icon_3w8ie0m6_');
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'BRAND_PRODUCT_LIST_SCREEN_Container_jknc');
              ...
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'BRAND_PRODUCT_LIST_SCREEN_Stack_yqxknyi4');
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final gridViewSearchbybrandsResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final searchProductList = getJsonField(
                                    gridViewSearchbybrandsResponse.jsonBody,
                                    r'''$.data''',
                                  ).toList();
                                  ...
                                  return RefreshIndicator(
                                    onRefresh: () async {
                                      logFirebaseEvent(
                                          'BRAND_PRODUCT_LIST_SCREEN_GridView_c4exi');
                                      logFirebaseEvent(
                                    ...
                                    child: GridView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'BRAND_PRODUCT_LIST_SCREEN_Container_6jhm');
                                            logFirebaseEvent(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  logFirebaseEvent('BRAND_PRODUCT_LIST_SCREEN_ADD_BTN_ON_TAP');
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Align(
                                                                                    ...
                                                                                    child: FFButtonWidget(
                                                                                      onPressed: () async {
                                                                                        logFirebaseEvent('BRAND_PRODUCT_LIST_SCREEN__BTN_ON_TAP');
                                                                                        if (functions.checkVariantFeatureCondition(searchProductListItem) == true) {
                                                                                          logFirebaseEvent('Button_bottom_sheet');
                                                                                          await showModalBottomSheet(
                                                                                            isScrollControlled: true,
                                                                ...
                                                                if ((getJsonField(
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'BRAND_PRODUCT_LIST_SCREEN_Row_a650kd4c_O');
                                                                      logFirebaseEvent(
                                                                          'Row_bottom_sheet');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      if (FFAppConstants
                                                                        ...
                                                                        return FlutterFlowIconButton(
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            logFirebaseEvent('BRAND_PRODUCT_LIST_SCREEN_notifications_');
                                                                            logFirebaseEvent('IconButton_custom_action');
                                                                            _model.connnectivtysearchproduct =
                                                                                await actions.checkInternetConnection();
                                                                            if (_model.connnectivtysearchproduct ==
                                                                                true) {
                                                                              logFirebaseEvent('IconButton_haptic_feedback');
                                                                              HapticFeedback.heavyImpact();
                                                                              logFirebaseEvent('IconButton_backend_call');
                                                                              _model.searchproduct = await QuickartGroup.addnotifymeCall.call(
                                                                              ...
                                                                              if ((_model.searchproduct?.succeeded ?? true)) {
                                                                        ...
                                                                        return Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('BRAND_PRODUCT_LIST_SCREEN_CircleImage_gz');
                                                      ...
                                                      if (FFAppConstants
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'BRAND_PRODUCT_LIST_SCREEN_Icon1_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon1_custom_action');
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'BRAND_PRODUCT_LIST_SCREEN_Icon2_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon2_custom_action');
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'BRAND_PRODUCT_LIST_SCREEN_cartbtnContain');
                                logFirebaseEvent(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'BRAND_PRODUCT_LIST_SCREEN_Row_c1p6q7y2_O');
              ...
              if (FFAppState().refreshTrigger == true)
                Container(
                  ...
                  child: FlutterFlowTimer(
                    ...
                    onEnded: () async {
                      logFirebaseEvent(
                          'BRAND_PRODUCT_LIST_SCREEN_Timer_aq8jtvgp');
