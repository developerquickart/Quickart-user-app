...
import 'top_deals_screen_model.dart';
export 'top_deals_screen_model.dart';

class TopDealsScreenWidget extends StatefulWidget {
  const TopDealsScreenWidget({
    super.key,
    this.utmSource,
    this.utmCampaign,
    this.utmNetwork,
  ...
  static String routeName = 'topDealsScreen';
  static String routePath = '/top-selling-product-list';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('TOP_DEALS_SCREEN_chevron_left_ICN_ON_TAP');
              ...
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'TOP_DEALS_SCREEN_Stack_f15ql4hx_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final gridViewTopsellingResponse = snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final productModel = getJsonField(
                                    gridViewTopsellingResponse.jsonBody,
                                    r'''$.data''',
                                  ).toList();
                                  ...
                                  return RefreshIndicator(
                                    onRefresh: () async {
                                      logFirebaseEvent(
                                          'TOP_DEALS_SCREEN_GridView_bkfhbesh_ON_PU');
                                      logFirebaseEvent(
                                    ...
                                    child: GridView.builder(
                                      ...
                                      itemBuilder:
                                        ...
                                        return InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'TOP_DEALS_SCREEN_Container_4fw0e6qh_ON_T');
                                            logFirebaseEvent(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                FFButtonWidget(
                                                                              onPressed: () async {
                                                                                logFirebaseEvent('TOP_DEALS_SCREEN_PAGE_ADD_BTN_ON_TAP');
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('TOP_DEALS_SCREEN_PAGE__BTN_ON_TAP');
                                                                                    if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                      logFirebaseEvent('Button_bottom_sheet');
                                                                                      await showModalBottomSheet(
                                                                                        isScrollControlled: true,
                                                                ...
                                                                if ((getJsonField(
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'TOP_DEALS_SCREEN_Row_od42to7p_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Row_bottom_sheet');
                                                                      await showModalBottomSheet(
                                                                        isScrollControlled:
                                                                    ...
                                                                    if (FFAppConstants
                                                                      ...
                                                                      return FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'TOP_DEALS_SCREEN_notifications_none_shar');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          if (_model.bestselling ==
                                                                            ...
                                                                            if ((_model.bestseller?.succeeded ??
                                                                                true)) {
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('TOP_DEALS_SCREEN_CircleImage_idzh2due_ON');
                                                      ...
                                                      if (FFAppConstants
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TOP_DEALS_SCREEN_PAGE_Icon1_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon1_custom_action');
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'TOP_DEALS_SCREEN_PAGE_Icon2_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Icon2_custom_action');
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'TOP_DEALS_SCREEN_cartbtnContainer_ON_TAP');
                                  logFirebaseEvent(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'TOP_DEALS_SCREEN_Row_0zhu21oo_ON_TAP');
