...
import '/index.dart';
import 'dart:async';
import 'top_deals_screen_widget.dart' show TopDealsScreenWidget;
import 'package:flutter/material.dart';

class TopDealsScreenModel extends FlutterFlowModel<TopDealsScreenWidget> {
  ...
  // Stores action output result for [Backend Call - API (seosource)] action in topDealsScreen widget.
