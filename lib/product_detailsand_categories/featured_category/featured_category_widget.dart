...
import 'featured_category_model.dart';
export 'featured_category_model.dart';

class FeaturedCategoryWidget extends StatefulWidget {
  ...
  static String routeName = 'FeaturedCategory';
  static String routePath = '/featured-categories-product-list';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final featuredCategoryFeaturedCategoryResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('FEATURED_CATEGORY_chevron_left_ICN_ON_TA');
            ...
            body: SafeArea(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('FEATURED_CATEGORY_Stack_crza9ws2_ON_TAP');
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final listViewFeaturecategoryResponse =
                                    snapshot.data!;

                                return Builder(
                                  builder: (context) {
                                    final featuredList =
                                        QuickartGroup.featurecategoryCall
                                                .data(
                                                  listViewFeaturecategoryResponse
                                                      .jsonBody,
                                                )
                                                ?.toList() ??
                                            [];
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemBuilder:
                                          (context, featuredListIndex) {
                                        final featuredListItem =
                                            featuredList[featuredListIndex];
                                        return InkWell(
                                          splashColor: Colors.transparent,
                                          focusColor: Colors.transparent,
                                          hoverColor: Colors.transparent,
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'FEATURED_CATEGORY_Container_mwm40dyg_ON_');
                                            logFirebaseEvent(
                            ...
                            child: Builder(
                              builder: (context) {
                                final productModel = getJsonField(
                                  featuredCategoryFeaturedCategoryResponse
                                      .jsonBody,
                                  r'''$.data''',
                                ).toList();
                                ...
                                return RefreshIndicator(
                                  onRefresh: () async {
                                    logFirebaseEvent(
                                        'FEATURED_CATEGORY_GridView_m6i50efl_ON_P');
                                    logFirebaseEvent(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, productModelIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'FEATURED_CATEGORY_Container_0my5jdjq_ON_');
                                          logFirebaseEvent(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                FFButtonWidget(
                                                                              onPressed: () async {
                                                                                logFirebaseEvent('FEATURED_CATEGORY_PAGE_ADD_BTN_ON_TAP');
                                                                                  ...
                                                                                  if (_model.internetcheck == true) {
                                                                                    ...
                                                                                    if ((_model.cartAdd?.succeeded ?? true)) {
                                                                                      if (FFAppConstants.checkStatus ==
                                                                                        ...
                                                                                        safeSetState(() => _model.apiRequestCompleter2 = null);
                                                                                        await _model.waitForApiRequestCompleted2(maxWait: 5000);
                                                                                        logFirebaseEvent('Button_custom_action');
                                                                                        await actions.facebookEventClass(
                                                                                          getJsonField(
                                                                                            productModelItem,
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    logFirebaseEvent('FEATURED_CATEGORY_PAGE__BTN_ON_TAP');
                                                                                    if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                      logFirebaseEvent('Button_bottom_sheet');
                                                                                      await showModalBottomSheet(
                                                                                        isScrollControlled: true,
                                                                                      ...
                                                                                      await _model.waitForApiRequestCompleted1(maxWait: 5000);
                                                                                    } else {
                                                                                      logFirebaseEvent('Button_custom_action');
                                                                                      _model.internetCheck = await actions.checkInternetConnection();
                                                                                      if (_model.internetCheck == true) {
                                                                                    ...
                                                                                    if (functions.checkVariantFeatureCondition(productModelItem) == true) {
                                                                                      ...
                                                                                      if (_model.connectivityResult123 == true) {
                                                                                        ...
                                                                                        if (getJsonField(
                                                                                          ...
                                                                                          logFirebaseEvent('Button_backend_call');
                                                                                          _model.apiResultAddCartwish = await QuickartGroup.addToCartCall.call(
                                                                                            userid: FFAppState().userID,
                                                                                            qty: functions.addRemoveQTY(
                                                                                                getJsonField(
                                                                                                  productModelItem,
                                                                                          ...
                                                                                          if ((_model.apiResultAddCartwish?.succeeded ?? true)) {
                                                                                            if (FFAppConstants.checkStatus ==
                                                                                                getJsonField(
                                                                                                  (_model.apiResultAddCartwish?.jsonBody ?? ''),
                                                                                                  r'''$.status''',
                                                                                                ).toString()) {
                                                                                              logFirebaseEvent('Button_refresh_database_request');
                                                                                              safeSetState(() => _model.apiRequestCompleter2 = null);
                                                              ...
                                                              if ((getJsonField(
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'FEATURED_CATEGORY_Row_3szwirbo_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Row_bottom_sheet');
                                                                    await showModalBottomSheet(
                                                                      isScrollControlled:
                                                                                    ...
                                                                                    children: [
                                                                                      TextSpan(
                                                                                        ...
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              ...
                                                                                              color: FFAppConstants.blackColor0A0A0A,
                                                                                              fontSize: MediaQuery.sizeOf(context).width < 375.0 ? 12.0 : 13.0,
                                                                                              letterSpacing: 0.0,
                                                                                              fontWeight: FontWeight.w600,
                                                                                              fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                                            ),
                                                                  ...
                                                                  if (FFAppConstants
                                                                    ...
                                                                    return FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'FEATURED_CATEGORY_notifications_none_sha');
                                                                        logFirebaseEvent(
                                                                            'IconButton_custom_action');
                                                                        _model.connnectivtyfavourites =
                                                                            await actions.checkInternetConnection();
                                                                        if (_model.connnectivtyfavourites ==
                                                                            true) {
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          _model.favourites = await QuickartGroup
                                                                              .addnotifymeCall
                                                                              .call(
                                                                            productID:
                                                                                getJsonField(
                                                                          ...
                                                                          if ((_model.favourites?.succeeded ??
                                                                              true)) {
                                                                            logFirebaseEvent('IconButton_refresh_database_request');
                                                                            safeSetState(() =>
                                                                                _model.apiRequestCompleter2 = null);
                                                                            await _model.waitForApiRequestCompleted2(maxWait: 2000);
                                                                          } else {
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'FEATURED_CATEGORY_CircleImage_95f9pthg_O');
                                                                          logFirebaseEvent(
                                                    ...
                                                    if (FFAppConstants
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'FEATURED_CATEGORY_PAGE_Icon1_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon1_custom_action');
                                                      ...
                                                      return Container(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'FEATURED_CATEGORY_PAGE_Icon2_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Icon2_custom_action');
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'FEATURED_CATEGORY_Row_izybqwbi_ON_TAP');
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'FEATURED_CATEGORY_cartbtnContainer_ON_TA');
                              logFirebaseEvent(
                    ...
                    if (FFAppState().refreshTrigger == true)
                      Container(
                        ...
                        child: FlutterFlowTimer(
                          ...
                          onEnded: () async {
                            logFirebaseEvent(
                                'FEATURED_CATEGORY_Timer_molb5ouc_ON_TIME');
