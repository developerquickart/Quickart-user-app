...
class Faq2Widget extends StatefulWidget {
  ...
  static String routeName = 'FAQ2';
  static String routePath = '/faq2';

  @override
  State<Faq2Widget> createState() => _Faq2WidgetState();
}

class _Faq2WidgetState extends State<Faq2Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'FAQ2'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('FAQ2_PAGE_chevron_left_ICN_ON_TAP');
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'Still need a support? We are available 24x7.',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.montserrat(
                            fontWeight: FontWeight.w600,
                            fontStyle: FlutterFlowTheme.of(context)
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('FAQ2_PAGE_Row_gibjzbkz_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('FAQ2_PAGE_Row_r9luo0hy_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('FAQ2_PAGE_Row_33g8m97q_ON_TAP');
