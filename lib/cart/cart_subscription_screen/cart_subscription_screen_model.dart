...
import 'dart:async';
import '/index.dart';
import 'cart_subscription_screen_widget.dart' show CartSubscriptionScreenWidget;
import 'package:flutter/material.dart';

class CartSubscriptionScreenModel
    extends FlutterFlowModel<CartSubscriptionScreenWidget> {
  ...
  // Stores action output result for [Backend Call - API (userbankdetails)] action in cartSubscriptionScreen widget.
