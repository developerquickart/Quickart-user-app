                ...
                children: [
                  Padding(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: QuickartGroup.notificationlistCall.call(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Builder(
                          builder: (context) {
                            final notificationModel = getJsonField(
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, notificationModelIndex) {
                                final notificationModelItem =
                                    notificationModel[notificationModelIndex];
                                return Container(
                                  decoration: BoxDecoration(
                                        ...
                                        child: ExpandablePanel(
                                          ...
                                          expanded: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Builder(
                                                builder: (context) {
                                                  final notificationList2 =
                                                      getJsonField(
                                                    notificationModelItem,
                                                    r'''$.notification_listing''',
                                                  ).toList();
                                                  ...
                                                  return ListView.separated(
                                                    ...
                                                    scrollDirection:
                                                        Axis.vertical,
                                                    itemCount: notificationList2
                                                        .length,
                                                    separatorBuilder: (_, __) =>
                                                        SizedBox(height: 5.0),
                                                    itemBuilder: (context,
                                                        notificationList2Index) {
                                                      final notificationList2Item =
                                                          notificationList2[
                                                              notificationList2Index];
                                                      return Container(
                                                        width:
                                                              ...
                                                              Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      ...
                                                                      color: functions.setNotificationBGColor(
                                                                          getJsonField(
                                                                            notificationModelItem,
                                                                            r'''$.noti_title''',
                                                                          ).toString(),
