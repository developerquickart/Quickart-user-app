...
import 'order_tracking_page_model.dart';
export 'order_tracking_page_model.dart';

class OrderTrackingPageWidget extends StatefulWidget {
  const OrderTrackingPageWidget({super.key});

  static String routeName = 'OrderTrackingPage';
  static String routePath = '/daily-order-details';

  @override
  State<OrderTrackingPageWidget> createState() =>
      _OrderTrackingPageWidgetState();
}

class _OrderTrackingPageWidgetState extends State<OrderTrackingPageWidget> {
  late OrderTrackingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderTrackingPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'OrderTrackingPage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ORDER_TRACKING_OrderTrackingPage_ON_INIT');
      logFirebaseEvent('OrderTrackingPage_refresh_database_reque');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
            ..complete(QuickartGroup.orderDetailAPICall.call(
      ...
      builder: (context, snapshot) {
        ...
        final orderTrackingPageOrderDetailAPIResponse = snapshot.data!;
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                leading: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ORDER_TRACKING_Icon_rdxo3to9_ON_TAP');
                    if (FFAppState().screenName == 'dashboard') {
                          ...
                          TextSpan(
                            text: valueOrDefault<String>(
                              functions.getIntegerValue(
                                  QuickartGroup.orderDetailAPICall
                                      .itemList(
              ...
              body: SafeArea(
                ...
                child: Stack(
                  children: [
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    if (FFAppConstants.orderStatusCompleted ==
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ORDER_TRACKING_RATE_ORDER_BTN_ON_TAP');
                                            logFirebaseEvent(
                                            ...
                                            context.pushNamed(
                                              RatingOrderScreenWidget.routeName,
                                              queryParameters: {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    if (FFAppConstants.orderStatusPending ==
                                        getJsonField(
                                          orderTrackingPageOrderDetailAPIResponse
                                              .jsonBody,
                                          r'''$.data.order_status''',
                                    ...
                                    if (FFAppConstants.orderStatusCompleted ==
                                      ...
                                      Builder(
                                        builder: (context) => FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ORDER_TRACKING_VIEW_ORDER_INVOICE_BTN_ON');
                                            if (FFAppState().nullValue !=
                                                getJsonField(
                                                  orderTrackingPageOrderDetailAPIResponse
                                                      .jsonBody,
                                                  r'''$.data.prodwiseinvoice''',
                                                ).toString()) {
                                              logFirebaseEvent(
                                                  'Button_navigate_to');
                                    ...
                                    if ((FFAppConstants.orderStatusCompleted ==
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'ORDER_TRACKING_BUY_AGAIN_BTN_ON_TAP');
                                          logFirebaseEvent(
                                        ...
                                        options: FFButtonOptions(
                                          ...
                                          iconPadding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 0.0, 0.0),
                                          iconColor: FFAppConstants.darkGreen,
                                          color: FFAppConstants.whiteColor,
                                          textStyle: FlutterFlowTheme.of(
                                                  context)
                                              .titleSmall
                                            ...
                                            if (FFAppConstants
                                              ...
                                              Builder(
                                                builder: (context) =>
                                                  ...
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'ORDER_TRACKING_DELIVERY_PROOF_BTN_ON_TAP');
                                                    if (FFAppState()
                                                            .nullValue !=
                                                        getJsonField(
                                                          orderTrackingPageOrderDetailAPIResponse
                                                              .jsonBody,
                                                          r'''$.data.delivery_proof''',
                                                        ).toString()) {
                                                      logFirebaseEvent(
                                                          'Button_update_page_state');
                                                      _model.deliveryProofImage =
                                                          true;
                                                      safeSetState(() {});
                                                    } else {
                                                      logFirebaseEvent(
                                        ...
                                        children: [
                                          ...
                                          if ((getJsonField(
                                              ...
                                              (getJsonField(
                                                    orderTrackingPageOrderDetailAPIResponse
                                                        .jsonBody,
                                                    r'''$.data.charges_json.timeslot_pricing.pricing_type''',
                                                  ) !=
                                                  null))
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                            ...
                                                            functions
                                                                .setDecimalValueWithCount(
                                                                    getJsonField(
                                                                      orderTrackingPageOrderDetailAPIResponse
                                                                          .jsonBody,
                                                                      r'''$.data.charges_json.timeslot_pricing.price_effect''',
                                                                    ).toString(),
                                                                    2,
                                                                    false),
                                                            style: FlutterFlowTheme
                                                          ...
                                                          () {
                                                            if (FFAppConstants
                                                              ...
                                                              return functions.setDecimalValue((String
                                                                      ...
                                                                      String
                                                                          trialDiscount) {
                                                                return ((double.parse(totalV) - double.parse(wallet) - double.parse(coupon)) <
                                                                            0
                                                                        ? 0.0
                                                                        : (double.parse(totalV) -
                                                                            double.parse(wallet) -
                              ...
                              if ((functions.isNullOrEmpty(getJsonField(
                                        orderTrackingPageOrderDetailAPIResponse
                                            .jsonBody,
                                        r'''$.data.special_instruction''',
                                      ).toString()) ==
                                      false) ||
                                  (functions.isNullOrEmpty(getJsonField(
                                        orderTrackingPageOrderDetailAPIResponse
                                            .jsonBody,
                                        r'''$.data.delivery_partner_instruction''',
                                      ).toString()) ==
                                      false))
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    if (productModel.isEmpty) {
                                      return Image.asset(
                                        'assets/images/No_product_available.png',
                                        width: 200.0,
                                        height: 200.0,
                                      );
                                    }
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ORDER_TRACKING_Image_ko5vg3se_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_navigate_to');
                                                                  ...
                                                                  child: Text(
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                              functions.setBgColorinIOrder(getJsonField(
                                                                            productModelItem,
                                                                            r'''$.prodorder_status''',
                                                                          ).toString()),
                                                                          fontSize:
                    ...
                    if (_model.deliveryProofImage == true)
                      InkWell(
                        splashColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        hoverColor: Colors.transparent,
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'ORDER_TRACKING_deliveryProofContainer_ON');
                          logFirebaseEvent(
                              'deliveryProofContainer_update_page_state');
                          _model.deliveryProofImage = false;
                          safeSetState(() {});
                        },
                        child: Container(
                          ...
                          child: Align(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                getJsonField(
                                  QuickartGroup.orderDetailAPICall.orderData(
                                    orderTrackingPageOrderDetailAPIResponse
                                        .jsonBody,
                                  ),
                                  r'''$.delivery_proof''',
                    ...
                    if (_model.invoicePdf == true)
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('ORDER_TRACKING_InvoicePDF_ON_TAP');
