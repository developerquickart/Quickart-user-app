              ...
              body: SafeArea(
                ...
                child: Stack(
                  children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SUBSCRIPTION_ORDER_PRODUCTS_Text_xdfnvqs');
                                      logFirebaseEvent(
                                          'Text_update_page_state');
                                      _model.isViewBillDetail = true;
                                      safeSetState(() {});
                    ...
                    if (_model.isViewBillDetail == true)
                      InkWell(
                        splashColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        hoverColor: Colors.transparent,
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'SUBSCRIPTION_ORDER_PRODUCTS_BillDetailCo');
                          logFirebaseEvent(
                              'BillDetailContainer_update_page_state');
                          _model.orderInfo = false;
                          _model.productData = null;
                          _model.isViewBillDetail = false;
                          safeSetState(() {});
                        },
                        child: Container(
                          width: MediaQuery.sizeOf(context).width * 1.0,
                          ...
                          child: Align(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SUBSCRIPTION_ORDER_PRODUCTS_Container_2j');
                                logFirebaseEvent('Container_update_page_state');
                                _model.orderInfo = false;
                                safeSetState(() {});
                              },
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SUBSCRIPTION_ORDER_PRODUCTS_Icon_w8n3i2q');
                                                  logFirebaseEvent(
                                                      'Icon_update_page_state');
                                                  _model.productData = null;
                                                  _model.isViewBillDetail =
                                                      false;
                                                  safeSetState(() {});
                                                  logFirebaseEvent(
                                          ...
                                          builder: (context) {
                                            ...
                                            return ListView.separated(
                                              ...
                                              separatorBuilder: (_, __) =>
                                                  SizedBox(height: 5.0),
                                              itemBuilder:
                                                  (context, billModelIndex) {
                                                final billModelItem =
                                                    billModel[billModelIndex];
                                                return Column(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  children: [
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                            ...
                                                                            if (_model.discount ==
                                                                              ...
                                                                              return FFAppConstants.darkGreen;
                                                                            } else if (_model.walletUsed ==
                                                                                getJsonField(
                                                                                  billModelItem,
                                                                                  r'''$.charge_type''',
                                                                              ...
                                                                              return FFAppConstants.redDF3F56;
                                                                            }
                                                                          }(),
                                                                          fontSize:
                                                                              14.0,
